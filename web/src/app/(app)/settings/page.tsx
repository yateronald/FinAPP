...
import { AiConsentDialog } from "@/components/ai/ai-access";
...
function PreferencesSection() {
  ...
  const { data: aiModels } = useAiModels(data?.aiEnabled === true);
  ...
  useEffect(() => {
    if (storeTheme)
      setDraft((d) =>
        d && d.theme !== storeTheme ? { ...d, theme: storeTheme } : d,
      );
  }, [storeTheme]);
  ...
  const changeAiAccess = (enabled: boolean) => {
    if (enabled) {
          ...
          <div className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setDraft({ ...draft, language: v as "FR" | "EN" })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="divide-y divide-border rounded-xl border border-border px-4">
              ...
              <Toggle
                ...
                description={
                  draft.aiEnabled ? t("aiOnSubtitle") : t("aiOffSubtitle")
                }
                onChange={changeAiAccess}
              />
            </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          setDraft({
                            ...draft,
                            aiProvider: v as UserSettings["aiProvider"],
                          })
                        }
                      >
                        <SelectTrigger>
            ...
            <AiConsentDialog
              ...
              onEnabled={(settings) => setDraft(settings)}
            />
          </div>
        )}
      </CardContent>
